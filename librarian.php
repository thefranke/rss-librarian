    ...
    function show_footer($param_id)
    {
        ...
        print('
            ...
            <p>
                ...
                '<a href="https://github.com/thefranke/rss-librarian/issues/new?body=Your%20description%20here...%0A%0A%60%60%60%0AFTE: ' . $g_config['extract_content'] . '%0AReadability: ' . file_exists($g_config['mod_readability']) . '%0ACustomextractor: ' . file_exists($g_config['mod_readability']) . '%0AUseRSS: ' . $g_config['use_rss_format'] . '%0AMaxItems: ' . $g_config['max_items'] . '%0AVersion: ' . get_version() . '%0A%60%60%60">Open a Github Issue</a><br>
            </p>
