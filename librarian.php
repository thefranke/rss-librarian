<?php
    ...
    // Get a simple local version number
    ...
    function show_footer($param_id)
    {
        ...
        $readability_loaded = class_exists('fivefilters\Readability\Readability');
        $custom_extractor_loaded = function_exists('custom_extractor');
        ...
        print('
            ...
            <p>
                ...
                Readability: ' . ($readability_loaded ? 'Enabled' : 'Disabled') . '<br>
                Custom extraction: ' . ($custom_extractor_loaded ? 'Enabled' : 'Disabled') . '<br>
